...
#       experiment.
VISUAL_GRAPH_DATASET: str = '/media/ssd/.visual_graph_datasets/datasets/compas'
...
def after_dataset(e: Experiment,
    ...
    for index, data in index_data_map.items():
        # The second graph label is the HOMO-LUMO Gap
        data['metadata']['graph']['graph_labels'] = data['metadata']['graph']['graph_labels'][1:2]

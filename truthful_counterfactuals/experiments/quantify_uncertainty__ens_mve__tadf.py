...
#       experiment.
VISUAL_GRAPH_DATASET: str = '/media/ssd/.visual_graph_datasets/datasets/tadf'
...
def after_dataset(e: Experiment,
    ...
    for index, data in index_data_map.items():
        ...
        if e.TARGET == 'energy':
            # This label (index 2) is the singlet triplet splitting energy
            data['metadata']['graph']['graph_labels'] = data['metadata']['graph']['graph_labels'][2:3]
